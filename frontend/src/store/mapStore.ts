...
export const useMapStore = create<MapStore>()(persist((set, get) => ({
  ...
  partialize: (s) => ({
    ...
    osmRailHexPaths: s.osmRailHexPaths,
    railEdges: s.railEdges,
    railsFetchTypes: s.railsFetchTypes,
    railsStatus: s.railsStatus,
    osmRiverWays: s.osmRiverWays,
    appliedOsmRiverIndices: s.appliedOsmRiverIndices,
    ...
    riverBlobCutRoughness: s.riverBlobCutRoughness,
    roadBlobCutEnabled: s.roadBlobCutEnabled,
    roadBlobCutWidth: s.roadBlobCutWidth,
    roadBlobCutRoughness: s.roadBlobCutRoughness,
